...
var (
	...
	argApiserverHost       = pflag.String("apiserver-host", "", "The address of the Centaurus Apiserver "+
		"to connect to in the format of protocol://address:port, e.g., "+
		"http://localhost:8080. If not specified, the assumption is that the binary runs inside a "+
		"Centaurus cluster and local discovery is attempted.")
	...
	argHeapsterHost    = pflag.String("heapster-host", "", "The address of the Heapster Apiserver "+
		...
		"Centaurus cluster and service proxy will be used.")
...
func main() {
	...
	pflag.Parse()
	_ = flag.CommandLine.Parse(make([]string, 0)) // Init for glog calls in centaurus packages
	...
	log.Printf("Running in Centaurus cluster version v%v.%v (%v)", versionInfo.Major, versionInfo.Minor, versionInfo.GitVersion)
...
func handleFatalInitError(err error) {
	log.Fatalf("Error while initializing connection to Centaurus apiserver. "+
